...
public class ConexionBD {
    ...
    private static final String URL = "jdbc:mysql://db:3306/edEXT_db?useSSL=false&serverTimezone=UTC";
    //hay que cambiarlo y crear un perfil exclusivo para la bd actualmente tiene mis claves xD
    private static final String USER = "UserLab";
    private static final String PASSWORD = "userlab";
