...
public class Presentacion extends javax.swing.JFrame {
    ...
    // 3. Centrar la ventana dentro del escritorio
    java.awt.Dimension desktopSize = jDesktopPane1.getSize();
    java.awt.Dimension frameSize = vCrearpf.getSize();
    vCrearpf.setLocation((desktopSize.width - frameSize.width) / 2, 
                         (desktopSize.height - frameSize.height) / 2);
  ...
  interfaces.ConsultaProgramaFormacion vConProgForm = new interfaces.ConsultaProgramaFormacion();
   jDesktopPane1.add(vConProgForm);
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        vConsultaEdicion.setLocation((desktopSize.width - frameSize.width) / 2, 
                      (desktopSize.height - frameSize.height) / 2);
        vConsultaEdicion.setVisible(true);
        vConsultaEdicion.toFront();
